    ...
    <ScrollView className="flex-1 bg-emerald-950">
      <View className="max-w-3xl mx-auto px-6 py-24">
        ...
        <View className="gap-y-12">
          <View>
            <Text className="text-xl font-black text-emerald-400 uppercase tracking-widest mb-4">1. Agreement to Terms</Text>
          ...
          <View>
            <Text className="text-xl font-black text-emerald-400 uppercase tracking-widest mb-4">2. Services</Text>
            <Text className="text-emerald-50/80 leading-relaxed font-light">
          ...
          <View>
            <Text className="text-xl font-black text-emerald-400 uppercase tracking-widest mb-4">3. Booking and Cancellations</Text>
            <Text className="text-emerald-50/80 leading-relaxed font-light">
          ...
          <View>
            <Text className="text-xl font-black text-emerald-400 uppercase tracking-widest mb-4">4. Liability</Text>
            <Text className="text-emerald-50/80 leading-relaxed font-light">
          ...
          <View>
            <Text className="text-xl font-black text-emerald-400 uppercase tracking-widest mb-4">5. Modifications</Text>
            <Text className="text-emerald-50/80 leading-relaxed font-light">
