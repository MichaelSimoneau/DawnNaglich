        ...
        <View className="gap-y-12">
          <View>
            ...
            <Text className="text-emerald-50/80 leading-relaxed font-light">
              Welcome to Dawn Naglich Wellness. Your privacy is critically
          ...
          <View>
            ...
            <Text className="text-emerald-50/80 leading-relaxed font-light">
              We collect information you provide directly to us when you book an
              appointment, such as your name, email address, and any session
              notes. We also collect data through Google Calendar integration if
          ...
          <View>
            ...
            <View className="ml-5 gap-y-2">
              <Text className="text-emerald-50/80 font-light">
          ...
          <View>
            ...
            <Text className="text-emerald-50/80 leading-relaxed font-light">
              ...
              data. Your information is stored securely via Firebase and Google
              Cloud services.
            </Text>
          </View>
          ...
          <View>
            ...
            <Text className="text-emerald-50/80 leading-relaxed font-light">
              ...
              dawn.naglich@gmail.com for any privacy-related requests.
            </Text>
          </View>
        </View>
