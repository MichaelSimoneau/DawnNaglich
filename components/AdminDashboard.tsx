...
const styles = StyleSheet.create({
  ...
  voiceBtn: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#059669', justifyContent: 'center', alignItems: 'center', shadowColor: '#059669', shadowOpacity: 0.3, shadowRadius: 10, elevation: 5 },
  ...
  apptMain: { flex: 1, backgroundColor: '#FFF', padding: 16, borderRadius: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderLeftWidth: 4, borderLeftColor: '#E2E8F0', shadowColor: '#000', shadowOpacity: 0.03, shadowRadius: 5 },
