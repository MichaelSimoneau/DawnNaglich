...
const styles = StyleSheet.create({
  ...
  logoBox: { width: 80, height: 80, backgroundColor: '#10B981', borderRadius: 24, justifyContent: 'center', alignItems: 'center', transform: [{ rotate: '3deg' }], marginBottom: 20 },
  ...
  card: { backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 40, padding: 30, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  ...
  submitBtn: { backgroundColor: '#10B981', borderRadius: 20, paddingVertical: 16, alignItems: 'center', marginTop: 10 },
